...
#How is calculated the max and min of character!?----
?max
...
#Double. The two most common numeric classes used in R are integer and double 
...
# Diplodia <- BOT1[BOT1$genus == 'Diplodia',2:ncol(BOT1)]
# Diplodia <- BOT[BOT1$genus == 'Diplodia',c(2,4)]
#BOT[row,columns]
...
#Homework Try to open the csv file 03-06-2019_netcdf_coords_to_extract.csv
data <- read.csv("03-06-2019_netcdf_coords_to_extract.csv")
